...
import ViewClientHealthDetails from "@/components/ui/admin/view-client-health-details";
            ...
            <label className="text-sm font-normal text-[#2F3E53] mb-1 flex items-center gap-1">
              ...
              <Tooltip>
                ...
                <TooltipContent side="right" className="max-w-xs">
                  E.g., dementia, Parkinson’s, stroke recovery
                </TooltipContent>
              </Tooltip>
            </label>
            <Input variant="bordered" type="text" placeholder="Enter" />
          ...
          <div className="col-span-12">
            <label className="text-sm font-normal text-[#2F3E53] mb-1 flex items-center gap-1">
              ...
              <Tooltip>
                ...
                <TooltipContent side="right" className="max-w-xs">
                  Include equipment used, medication, hospital visits, or external specialists
                </TooltipContent>
              </Tooltip>
            </label>
